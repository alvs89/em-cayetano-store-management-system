...
const roleHelpAccess = {
  [ROLE_VALUES.ADMIN]: {
    ...
    tasks: [
      ...
      'Add and edit inventory items, stock thresholds, categories, supplier details, and approval requests.',
      ...
      'Use maintenance, backup, restore, data integrity, and audit trail tools.',
    ],
  },
...
const faqs = [
  ...
  {
    id: 'dashboard-purpose-admin',
    roles: HELP_ROLES.ADMIN,
    question: 'What is the Dashboard for?',
    answer: 'The Dashboard shows management-level information such as sales activity, profit indicators, stock alerts, pending review items, quick actions, and recent branch activity.',
  },
  {
    id: 'dashboard-purpose-sales',
    roles: [ROLE_VALUES.SALES_ENCODER],
    question: 'What is the Dashboard for?',
    answer: 'The Dashboard shows sales-related reminders, available shortcuts, stock alerts, and activity information needed for daily sales encoding work.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Open Sales History, choose the completed sale, select the refundable items, enter the quantity and reason, check the item condition, then confirm. Only resalable returned items go back to sellable stock.',
  },
  {
    id: 'bank-transfer-pending',
    roles: HELP_ROLES.SALES,
    question: 'Why is a bank transfer marked as pending?',
    answer: 'Bank transfer sales are saved as pending while the payment reference is checked. Stock is reserved during this stage and deducted only after the payment is completed.',
  },
  {
    id: 'stock-not-enough',
    roles: HELP_ROLES.SALES,
  ...
  {
    id: 'inventory-approval-requests',
    roles: HELP_ROLES.INVENTORY,
    question: 'Why does an item request need Admin review?',
    answer: 'Add item and edit item requests prepared by Inventory Staff are reviewed by an Admin before they become official inventory records. This protects item names, categories, suppliers, prices, and stock planning details.',
  },
  {
    id: 'inventory-record-changed',
    roles: HELP_ROLES.INVENTORY,
    question: 'Why does the system say an inventory item was changed by another user?',
    answer: 'Another user saved a newer version of the item while your form was open. Review the latest item details before saving again so newer information is not overwritten.',
  },
  {
    id: 'draft-recovery',
    roles: HELP_ROLES.ALL,
    question: 'What should I do when an unfinished draft is found?',
    answer: 'Choose Resume Draft to continue editing or Discard to remove it. Drafts are not official records and do not affect stock, reports, or dashboard totals until they are submitted.',
  },
  {
    id: 'receive-delivery',
    roles: HELP_ROLES.INVENTORY,
  ...
  },
  {
    ...
    answer: 'A browser may show records loaded before another user completed an action. Refresh the module or return to the page to load the latest saved database records.',
  },
  {
    id: 'backup-restore',
    roles: HELP_ROLES.ADMIN,
    question: 'What should I remember before restoring a database backup?',
    answer: 'Use only a complete SQL backup generated by this system. Confirm the file before restoring because restore replaces current application records with the selected backup contents.',
  },
  {
    id: 'manage-users',
    roles: HELP_ROLES.ADMIN,
...
const guides = [
  ...
  },
  {
    ...
    summary: 'Return selected items from a completed sale with a clear reason and item condition.',
    steps: [
      'Open Sales History.',
      'Select the completed sale.',
      'Choose the item or items to refund.',
      'Enter the refund quantity and select or type a clear refund reason.',
      'Choose the returned item condition.',
      'Review the refund summary.',
      'Confirm the refund.',
    ],
  },
  {
    id: 'draft-recovery-guide',
    roles: HELP_ROLES.ALL,
    title: 'Resuming an Unfinished Draft',
    summary: 'Continue saved work after an interruption.',
    steps: [
      'Open the module or dialog where the unfinished work was started.',
      'Review the draft notice shown by the system.',
      'Choose Resume Draft to continue editing.',
      'Choose Discard only when the saved draft is no longer needed.',
      'Submit the form only after reviewing all details.',
    ],
  },
  {
    id: 'cancel-sale',
  ...
  {
    id: 'inventory-request-review',
    roles: HELP_ROLES.ADMIN,
    title: 'Reviewing Inventory Approval Requests',
    summary: 'Approve or reject item requests prepared by Inventory Staff.',
    steps: [
      'Open Inventory.',
      'Open Inventory Approval Requests when pending requests are available.',
      'Use search, sorting, and request filters when needed.',
      'Review the item name, requester, request date, and changed fields.',
      'Approve only when the request is correct, or reject it with a clear reason.',
    ],
  },
  {
    ...
    steps: [
      'Open Inventory.',
      'Choose Add Item or edit an existing item when permitted.',
      'Enter accurate item, category, supplier, price, cost, and planning details.',
      'Review the form before submitting.',
      'Wait for Admin review before treating the request as official.',
    ],
  },
  {
    id: 'updating-stock',
  ...
  },
  {
    ...
    summary: 'Protect business records through controlled maintenance actions.',
    steps: [
      'Open Maintenance.',
      'Download a database backup when a safe copy is needed.',
      'Store the backup file in a secure location.',
      'Before restoring, confirm that the selected SQL file is the correct system backup.',
      'Run restore only when replacing current records is intended.',
    ],
  },
];
...
const troubleshooting = [
  ...
  },
  {
    ...
    roles: HELP_ROLES.INVENTORY,
    title: 'Inventory item changed while editing',
    cause: 'Another user saved a newer version of the item while your form was open.',
    solution: 'Close the form, load the latest item details, review the current values, and save again only if the change is still needed.',
  },
  {
    id: 'draft-notice',
    roles: HELP_ROLES.ALL,
    title: 'Unfinished draft notice appears',
    cause: 'The system saved unfinished form entries after a refresh, tab closure, or interruption.',
    solution: 'Select Resume Draft to continue working or Discard when the draft is no longer needed.',
  },
  {
    id: 'report-empty',
    roles: HELP_ROLES.INVENTORY,
  ...
  {
    id: 'browser-stale-data',
    roles: HELP_ROLES.ALL,
    title: 'Another browser still shows old records',
    cause: 'That browser may still be showing information loaded before another user completed an action.',
    solution: 'Refresh the module, return to the page, or wait for the next automatic refresh to show the latest saved data.',
  },
  {
    id: 'restore-failed',
    roles: HELP_ROLES.ADMIN,
    title: 'Database restore failed',
    cause: 'The selected SQL file may be incomplete, from another system, or not compatible with the current application schema.',
    solution: 'Use a complete backup generated by this system and confirm the file before restoring again.',
  },
  {
...
const manualIntroduction = {
  ...
  overview: [
    ...
    'Prepare and review inventory approval requests based on role access.',
    'Recover unfinished drafts without creating official records before submission.',
...
const interfaceOverview = [
  ...
  'Draft notices: allow unfinished work to be resumed or discarded before final submission.',
...
const manualWorkflows = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Select a common refund reason or enter a clear custom reason.',
      'Choose the returned item condition so the system can decide the stock result.',
  ...
  },
  {
    id: 'draft-workflow',
    roles: HELP_ROLES.ALL,
    title: 'Draft Recovery Workflow',
    steps: [
      'Return to the module or form where work was interrupted.',
      'Read the draft notice shown by the system.',
      'Select Resume Draft to continue or Discard when the draft is no longer needed.',
      'Review all entries before submitting the official record.',
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      'Enter accurate item details, pricing, supplier, and planning values.',
      'Submit the request for Admin review.',
      'Check the request status from Inventory after review.',
    ],
  },
  {
    id: 'approval-workflow',
    roles: HELP_ROLES.ADMIN,
    title: 'Inventory Approval Workflow',
    steps: [
      'Open Inventory and select Inventory Approval Requests.',
      'Search or filter pending requests when needed.',
      'Review the item name, requester, request date, and changed values.',
      'Approve correct requests or reject requests that need correction.',
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      'Select restore only when the backup should replace current records.',
      'Use only a valid SQL backup generated by this system.',
...
const dataEntryRules = [
  ...
  { id: 'wait-for-save', roles: HELP_ROLES.ALL, text: 'Wait for the system message after saving before clicking the same confirm button again.' },
  ...
  { id: 'bank-transfer-reference', roles: HELP_ROLES.SALES, text: 'Enter the bank transfer reference before saving a bank transfer sale.' },
  { id: 'refund-condition', roles: HELP_ROLES.SALES, text: 'Choose the returned item condition carefully because it controls whether stock can return to sellable inventory.' },
...
const glossaryTerms = [
  ...
  { term: 'Approval Request', roles: HELP_ROLES.INVENTORY, definition: 'An add item or edit item request prepared for Admin review before it becomes an official inventory change.' },
  ...
  { term: 'Bank Transfer Pending', roles: HELP_ROLES.SALES, definition: 'A bank transfer sale waiting for payment verification. Its stock is reserved but not yet deducted.' },
  ...
  { term: 'Conflict Notice', roles: HELP_ROLES.INVENTORY, definition: 'A message shown when another user changed the same inventory record before the current form was saved.' },
  ...
  { term: 'Draft', roles: HELP_ROLES.ALL, definition: 'Unfinished form work saved for recovery. Drafts are not official transactions and do not affect stock or reports.' },
  ...
  { term: 'Refund Transaction', roles: HELP_ROLES.SALES, definition: 'The separate record created when a refund is saved for a completed sale.' },
  { term: 'Report Period', roles: HELP_ROLES.INVENTORY, definition: 'The selected date range used when generating reports.' },
  { term: 'Returned Item Condition', roles: HELP_ROLES.SALES, definition: 'The condition selected during refund processing. Only resalable or unused items can return to sellable stock.' },
